...
function __import2(e){
    if((srcTranslated.value === 'Searching..') || srcTranslated.value == ''){
        srcTranslated.value = e.data.value
    } else {
        srcTranslated.value += e.data.value                
    }
...
mysql_wn_data_synsets_II.addEventListener('message',__import,file00)
mysql_wn_data_synsets_inverse_II.addEventListener('message',__import,file01)
mysql_wn_data_sense_inverse.addEventListener('message',__import,file02)
mysql_wn_data_examples.addEventListener('message',__import,file03)/*

mysql_wn_data_noun_act.addEventListener('message',__import2,file04)
mysql_wn_data_noun_animal.addEventListener('message',__import2,file05)
mysql_wn_data_noun_artifact.addEventListener('message',__import2,file06)
mysql_wn_data_noun_attribute.addEventListener('message',__import2,file07)
mysql_wn_data_noun_body.addEventListener('message',__import2,file08)
mysql_wn_data_noun_cognition.addEventListener('message',__import2,file09)
mysql_wn_data_noun_communication.addEventListener('message',__import2,file10)
mysql_wn_data_noun_event.addEventListener('message',__import2,file11)
mysql_wn_data_noun_feeling.addEventListener('message',__import2,file12)
mysql_wn_data_noun_food.addEventListener('message',__import2,file13)
mysql_wn_data_noun_group.addEventListener('message',__import2,file14)
mysql_wn_data_noun.addEventListener('message',__import2,file15)
mysql_wn_data_noun_location.addEventListener('message',__import2,file16)
mysql_wn_data_noun_motive.addEventListener('message',__import2,file17)
mysql_wn_data_noun_object.addEventListener('message',__import2,file18)
mysql_wn_data_noun_person.addEventListener('message',__import2,file19) //zweig
mysql_wn_data_noun_phenomenon.addEventListener('message',__import2,file20) //parallax
mysql_wn_data_noun_plant.addEventListener('message',__import2,file21)
mysql_wn_data_noun_possession.addEventListener('message',__import2,file22)
mysql_wn_data_noun_process.addEventListener('message',__import2,file23)
mysql_wn_data_noun_quantity.addEventListener('message',__import2,file24)
mysql_wn_data_noun_relation.addEventListener('message',__import2,file25)
mysql_wn_data_noun_shape.addEventListener('message',__import2,file26)
mysql_wn_data_noun_substance.addEventListener('message',__import2,file27)
mysql_wn_data_noun_time.addEventListener('message',__import2,file28)
mysql_wn_data_noun_Tops.addEventListener('message',__import2,file29)

mysql_wn_data_verb_body.addEventListener('message',__import2,file30)
mysql_wn_data_verb_change.addEventListener('message',__import2,file31)
mysql_wn_data_verb_cognition.addEventListener('message',__import2,file32)
mysql_wn_data_verb_communication.addEventListener('message',__import2,file33)
mysql_wn_data_verb_competition.addEventListener('message',__import2,file34)
mysql_wn_data_verb_consumption.addEventListener('message',__import2,file35)
mysql_wn_data_verb_contact.addEventListener('message',__import2,file36)
mysql_wn_data_verb_emotion.addEventListener('message',__import2,file37)
mysql_wn_data_verb.addEventListener('message',__import2,file38)
mysql_wn_data_verb_motion.addEventListener('message',__import2,file39)
mysql_wn_data_verb_perception.addEventListener('message',__import2,file40)
mysql_wn_data_verb_possession.addEventListener('message',__import2,file41)
mysql_wn_data_verbs.addEventListener('message',__import2,file42)
mysql_wn_data_verb_social.addEventListener('message',__import2,file43)
mysql_wn_data_verb_stative.addEventListener('message',__import2,file44)
mysql_wn_data_verb_weather.addEventListener('message',__import2,file45)
mysql_wn_data_verb_creation.addEventListener('message',__import2,file46)*/
...
var intf = {
    ...
    0:function(){ // lookup
        ...
        mysql_wn_data_synsets_II.postMessage(arguments[0])
        }, // lookup
    1:function(){ // ilookup
        srcTranslated.value = 'Processing..'
        mysql_wn_data_synsets_inverse_II.postMessage(arguments[0])
        }, // ilookup
    ...
    31:function(){ // available attribute flags
        ...
        var N = archive.length
        for (var i=0; i<N; i++){
            var a = new Worker(archive[i])
            a.onmessage = __import2
            a.postMessage(arguments[0])               
            a = undefined
        }
        /*mysql_wn_data_noun_act.postMessage (arguments[0])
        mysql_wn_data_noun_animal.postMessage (arguments[0])    
        mysql_wn_data_noun_artifact.postMessage (arguments[0]) 
        mysql_wn_data_noun_attribute.postMessage (arguments[0]) 
        mysql_wn_data_noun_body.postMessage (arguments[0]) 
        mysql_wn_data_noun_cognition.postMessage (arguments[0])
        mysql_wn_data_noun_communication.postMessage (arguments[0])
        mysql_wn_data_noun_event.postMessage (arguments[0])
        mysql_wn_data_noun_feeling.postMessage (arguments[0])
        mysql_wn_data_noun_food.postMessage (arguments[0])
        mysql_wn_data_noun_group.postMessage (arguments[0])
        mysql_wn_data_noun.postMessage (arguments[0]) 
        mysql_wn_data_noun_location.postMessage (arguments[0])
        mysql_wn_data_noun_motive.postMessage (arguments[0])
        mysql_wn_data_noun_object.postMessage (arguments[0])        
        mysql_wn_data_noun_person.postMessage (arguments[0])
        
        mysql_wn_data_noun_phenomenon.postMessage (arguments[0])              
        mysql_wn_data_noun_plant.postMessage (arguments[0])
        mysql_wn_data_noun_possession.postMessage (arguments[0])
        mysql_wn_data_noun_process.postMessage (arguments[0])
        mysql_wn_data_noun_quantity.postMessage (arguments[0])
        mysql_wn_data_noun_relation.postMessage (arguments[0])
        mysql_wn_data_noun_shape.postMessage (arguments[0])
        mysql_wn_data_noun_substance.postMessage (arguments[0])
        mysql_wn_data_noun_time.postMessage (arguments[0])
        mysql_wn_data_noun_Tops.postMessage (arguments[0])

        mysql_wn_data_verb_body.postMessage (arguments[0])
        mysql_wn_data_verb_change.postMessage (arguments[0])
        mysql_wn_data_verb_cognition.postMessage (arguments[0])
        mysql_wn_data_verb_communication.postMessage (arguments[0])
        mysql_wn_data_verb_competition.postMessage (arguments[0])
        mysql_wn_data_verb_consumption.postMessage (arguments[0])
        mysql_wn_data_verb_contact.postMessage (arguments[0])
        mysql_wn_data_verb_emotion.postMessage (arguments[0])
        mysql_wn_data_verb.postMessage (arguments[0])
        mysql_wn_data_verb_motion.postMessage (arguments[0])
        mysql_wn_data_verb_perception.postMessage (arguments[0])
        mysql_wn_data_verb_possession.postMessage (arguments[0])
        mysql_wn_data_verbs.postMessage (arguments[0])
        mysql_wn_data_verb_social.postMessage (arguments[0])
        mysql_wn_data_verb_stative.postMessage (arguments[0])
        mysql_wn_data_verb_weather.postMessage (arguments[0])
        mysql_wn_data_verb_creation.postMessage (arguments[0])*/   
        },    
}
